      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-12 items-center">
        <div className="space-y-8 animate-fade-in-up z-10 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center lg:justify-start">
            <button className="bg-brand-600 text-white text-lg font-semibold px-8 py-4 rounded-full shadow-xl shadow-brand-600/30 hover:bg-brand-700 hover:shadow-brand-600/50 transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center gap-2 group">
          ...
          <div className="pt-8 flex items-center gap-6 text-sm text-slate-500 font-medium">
             ...
             <div>Trusted by 10,000+ creators</div>
          </div>
        </div>
        ...
        <div className="relative perspective-1000 group">
          ...
          <div className="relative z-10 liquid-glass rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-10 rotate-y-12 hover:rotate-0 transition-all duration-700 ease-out preserve-3d">
            <div className="flex justify-between items-start mb-10">
               <div>
                 ...
                 <h3 className="text-4xl font-bold text-slate-900 tracking-tight">$24,500.00</h3>
               </div>
            ...
            <div className="space-y-4">
              {[
                ...
                { label: 'Figma Subscription', amount: '-$15.00', time: '1 hr ago', icon: 'bg-red-100 text-red-600' },
                { label: 'Client Transfer', amount: '+$1,850.00', time: 'Yesterday', icon: 'bg-green-100 text-green-600' }
              ].map((item, i) => (
          ...
          <div className="absolute top-[20%] -right-12 z-20 liquid-glass p-5 rounded-3xl animate-float shadow-2xl hidden md:block border-white/40">
             <div className="flex items-center gap-4">
                ...
                <div><p className="text-[10px] font-bold text-slate-400 tracking-wider">USD ACCOUNT</p> <p className="text-base font-bold text-slate-900">$12,050</p></div>
             </div>
          </div>
          ...
          <div className="absolute bottom-[20%] -left-12 z-20 liquid-glass p-5 rounded-3xl animate-float shadow-2xl hidden md:block border-white/40" style={{ animationDelay: '2s' }}>
             <div className="flex items-center gap-4">
                ...
                <div><p className="text-[10px] font-bold text-slate-400 tracking-wider">EUR ACCOUNT</p> <p className="text-base font-bold text-slate-900">€8,420</p></div>
             </div>
          </div>
        </div>
      </div>
